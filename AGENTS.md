...
This project is indexed by GitNexus as **cernion-energy-tools** (17858 symbols, 22194 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
