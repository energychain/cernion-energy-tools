...
module.exports = {
  ...
  domainResult: {
      ...
      tasks: [
        {
          ...
          evidenceGaps: [
            { id: 'formal-request', label: 'Formaler §17-EnWG-Antrag', reason: 'nicht eingereicht' },
          ],
          forbiddenAssumptions: [
            'Keine belastbare Anschlusszusage ohne formalen Antrag',
          ],
          nextActions: [
            { id: 'na-1', type: 'formal_request', label: 'Formalen Antrag bei TWL Netze einreichen' },
          ],
        },
      ],
    },
    ...
    evidenceGaps: [
      { id: 'operator-confirmation', label: 'Verbindliche Bestätigung Netzbetreiberzuständigkeit', reason: 'noch offen' },
    ],
    forbiddenAssumptions: [
      'User-Angabe zum Netzbetreiber darf nicht als verifizierte Evidenz gelten',
    ],
    nextActions: [
      { id: 'na-2', type: 'evidence', label: 'Zuständigkeitsnachweis und BKZ-Unterlagen nachreichen' },
    ],
