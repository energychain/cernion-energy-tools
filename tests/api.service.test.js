...
describe('API Gateway Service', () => {
  ...
  describe('openapi', () => {
    ...
    it('should have explicit aliases for Dashboard API and Observability routes', () => {
      ...
      expect(aliases['GET /dashboard/connection-deadline-evidence-queue']).toBe(
      ...
      expect(aliases['GET /dashboard/stadtwerk-mauer-workbench-hub']).toBe(
      ...
      expect(aliases['GET /dashboard/stadtwerk-mauer-grid-planning-selected-item-detail']).toBe(
        'dashboard-api.stadtwerkMauerGridPlanningSelectedItemDetailStatus'
      );
      expect(aliases['GET /dashboard/stadtwerk-mauer-sales-workbench-briefing']).toBe(
        'dashboard-api.stadtwerkMauerSalesWorkbenchBriefingStatus'
      );
      expect(aliases['GET /dashboard/stadtwerk-mauer-workbench-selected-target']).toBe(
      ...
      expect(aliases['POST /dashboard/stadtwerk-mauer-case-annotations']).toBe(
      ...
      expect(aliases['GET /dashboard/evidence-freshness-guard']).toBe(
      ...
      expect(aliases['GET /dashboard/model-viability-evidence-gate']).toBe(
      ...
      expect(aliases['POST /agent-sidecar/mcp/tools/:name/call']).toBe('agent-sidecar.mcpCallTool');
