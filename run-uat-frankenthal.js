...
async function runUAT() {
  ...
  await runTurn(1, "Ich bin Analyst bei einer Bank und prüfe gerade ein Batteriespeicher-Projekt. Kannst du mir helfen, das zu bewerten?");
  await runTurn(2, "Standort ist Frankenthal (Pfalz), Industriegebiet. Kapazität 12 MW. Netzbetreiber soll laut Prospekt TWL Netze sein.");
  await runTurn(3, "Okay, danke für die Korrektur. Gehen wir von den Stadtwerken Frankenthal aus. Was ist der nächste formale Schritt für die Anschlusszusage nach dem EnWG, wenn wir das finanzieren wollen?");
