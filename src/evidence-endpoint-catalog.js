...
const ENTSOE_ENERGY_MARKET_ENTRIES = [
  ...
  },
  {
    ...
    semanticFacts: [
      'Day-ahead electricity spot price time series (EUR/MWh) with min/max/avg statistics.',
    ],
    freshness: 'current',
    granularity: 'hourly',
    timeRangeSupport: true,
  ...
  },
  {
    ...
    semanticFacts: [
      'Day-ahead/intraday/futures electricity market price array for the requested market and region.',
    ],
    freshness: 'current',
    granularity: 'hourly',
    timeRangeSupport: true,
