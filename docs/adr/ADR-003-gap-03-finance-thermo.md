...
- Der Finance Agent ist deterministisch (kein LLM), daher koennen keine neuen oekonomischen Domaenen "ad-hoc" gelernt werden
...
- Nachteile: Jede neue Domaene erfordert Code-Aenderung
