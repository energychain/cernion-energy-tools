...
const COMMUNITY_INTENTS = {
  prosumer_basics: {
    ...
    sources: [
      {
        type: 'regulatory_basics',
        name: 'Erneuerbare-Energien-Gesetz (EEG)',
        evidenceId: 'eeg-basics',
      },
    ],
    consultation: {
      openQuestions: [
        'Möchten Sie wissen, wie Sie Ihren Eigenverbrauch optimieren?',
        'Suchen Sie Unterstützung bei der Anmeldung Ihrer Anlage?',
      ],
  ...
  device_support_hoymiles: {
    ...
    reply:
      'Hoymiles-Wechselrichter (insbesondere die HM- und HMS-Serien wie HM-600, HM-800 oder die neueren HMS-800W-2T mit integriertem WLAN) werden im Corrently-Ökosystem und von Cernion voll unterstützt. Die Datenhaltung und -visualisierung kann über offene Schnittstellen wie OpenDTU oder AhoyDTU via MQTT-Broker angebunden werden, um Echtzeit-Einspeisewerte und Diagnosedaten lokal oder in der Cloud ohne herstellereigene Cloud-Zwänge auszuwerten.',
    sources: [
      {
        type: 'device_integration',
        name: 'Hoymiles OpenDTU MQTT Connector',
        evidenceId: 'hoymiles-mqtt',
      },
    ],
    consultation: {
      openQuestions: [
        'Nutzen Sie bereits eine OpenDTU oder AhoyDTU?',
        'Möchten Sie die MQTT-Verbindungsdaten konfigurieren?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
  ...
  home_storage_roi: {
    ...
    sources: [
      {
        type: 'economics',
        name: 'HTW Berlin Stromspeicher-Inspektion',
        evidenceId: 'storage-roi-htw',
      },
    ],
    consultation: {
      openQuestions: [
        'Wie hoch ist Ihr jährlicher Stromverbrauch?',
        'Welche PV-Leistung ist bei Ihnen installiert?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
  ...
  dynamic_tariff_explain: {
    ...
    sources: [
      { type: 'tariff_info', name: 'EPEX Spot Day-Ahead Market', evidenceId: 'epex-basics' },
    ],
    consultation: {
      openQuestions: [
        'Besitzen Sie bereits ein intelligentes Messsystem (iMSys)?',
        'Möchten Sie die aktuellen Day-Ahead Börsenstrompreise einsehen?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
  ...
  section14a_consumer: {
    ...
    sources: [
      {
        type: 'regulatory_14a',
        name: 'Bundesnetzagentur Beschluss BK6-22-300 (§14a)',
        evidenceId: 'bnetza-14a',
      },
    ],
    consultation: {
      openQuestions: [
        'Möchten Sie das reduzierte Netzentgelt für Ihre Region berechnen?',
        'Ist Ihre Anlage bereits beim Netzbetreiber registriert?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
  ...
  feed_in_economics: {
    ...
    sources: [
      { type: 'economics_eeg', name: 'EEG Vergütungssätze 2026', evidenceId: 'eeg-economics' },
    ],
    consultation: {
      openQuestions: [
        'Kennen Sie Ihren aktuellen Haushaltsstrompreis?',
        'Möchten Sie die Amortisation Ihrer PV-Anlage kalkulieren?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
  ...
  smart_meter_basics: {
    ...
    reply:
      'Ein Smart Meter (Intelligentes Messsystem, iMSys) besteht aus einer modernen Messeinrichtung (digitaler Stromzähler) und einer Kommunikationseinheit, dem sogenannten Smart-Meter-Gateway (SMGW). Es übermittelt die Zählerstände vollautomatisch und verschlüsselt an den Messstellenbetreiber und Netzbetreiber. Gemäß dem Messstellenbetriebsgesetz (MsbG) läuft der flächendeckende Rollout in Deutschland verpflichtend für Haushalte mit einem Verbrauch über 6.000 kWh/Jahr oder PV-Anlagen ab 7 kWp.',
    sources: [
      {
        type: 'regulatory_msbg',
        name: 'Messstellenbetriebsgesetz (MsbG)',
        evidenceId: 'msbg-basics',
      },
    ],
    consultation: {
      openQuestions: [
        'Wie hoch ist Ihr jährlicher Stromverbrauch?',
        'Haben Sie bereits einen digitalen Zähler installiert?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
  ...
  corrently_tariff_fit: {
    ...
    reply:
      'Der Corrently-Tarif kombiniert die Vorzüge eines dynamischen Stromtarifs mit regionaler Grünstrom-Kompensation und dem Grünstrom-Index (GSI). Ob der Tarif perfekt zu Ihnen passt, lässt sich durch eine Analyse Ihres Lastprofils ermitteln. Insbesondere Haushalte mit steuerbaren Lasten (Wärmepumpe, E-Auto) oder einer eigenen PV-Anlage profitieren enorm, da sie ihren Bezug in kostengünstige und zugleich besonders saubere Stunden verlagern können.',
    sources: [
      {
        type: 'tariff_fit',
        name: 'Corrently GSI Tarifbedingungen',
        evidenceId: 'corrently-fit-terms',
      },
    ],
    consultation: {
      openQuestions: [
        'Besitzen Sie eine Wallbox oder Wärmepumpe?',
        'Möchten Sie Ihre potenzielle Ersparnis berechnen?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
  community_general: {
    ...
    reply:
      'Herzlich willkommen bei der Corrently Community Beratung! Ich unterstütze Sie gerne bei allen Fragen rund um Prosumer-Konzepte, Balkonkraftwerke, Netzentgelte nach §14a EnWG, dynamische Stromtarife und nachbarschaftliches Energy Sharing. Geben Sie einfach Ihr Anliegen oder Ihre Postleitzahl ein, um spezifische Auskünfte zu erhalten.',
    sources: [
      { type: 'community_info', name: 'Corrently Community Portal', evidenceId: 'community-hub' },
    ],
    consultation: {
      openQuestions: [
        'Welche Energie-Themen interessieren Sie heute besonders?',
        'Möchten Sie Ihren lokalen Netzbetreiber identifizieren?',
      ],
      executionReadiness: 'ready_to_explain',
    },
  },
    ...
    consult: {
      ...
      params: {
        ...
        audience: {
          type: 'enum',
          optional: true,
          values: ['community', 'prosumer', 'regulatory'],
          default: 'community',
        },
      ...
      openapi: {
        ...
        tags: ['Community'],
        description:
          'Primary entrypoint for consumer-oriented queries regarding PV, balcony solar, dynamic tariffs, and §14a EnWG.',
      },
      ...
      async handler(ctx) {
        ...
        if (
          msgLower.includes('grundlagen') ||
          msgLower.includes('einsteiger') ||
          msgLower.includes('prosumer') ||
          msgLower.includes('basics')
        ) {
          detectedIntent = 'prosumer_basics';
        } else if (
          msgLower.includes('balkon') ||
          msgLower.includes('stecker-solar') ||
          msgLower.includes('balkonsolar')
        ) {
          detectedIntent = 'balcony_pv_value';
        } else if (
          msgLower.includes('hoymiles') ||
          msgLower.includes('hm-') ||
          msgLower.includes('hms-')
        ) {
          detectedIntent = 'device_support_hoymiles';
        } else if (
          msgLower.includes('ertrag') ||
          msgLower.includes('erzeugung') ||
          msgLower.includes('diagnose') ||
          msgLower.includes('minderertrag')
        ) {
          detectedIntent = 'pv_yield_diagnostics';
        } else if (
          msgLower.includes('speicher') ||
          msgLower.includes('akkumulator') ||
          msgLower.includes('batterie')
        ) {
          detectedIntent = 'home_storage_roi';
        } else if (
          msgLower.includes('reihenfolge') ||
          msgLower.includes('ablauf') ||
          msgLower.includes('hausenergie') ||
          msgLower.includes('sanierungsfahrplan')
        ) {
          detectedIntent = 'home_energy_sequence';
        } else if (
          msgLower.includes('dynamischer tarif') ||
          msgLower.includes('dynamische tarife') ||
          msgLower.includes('stromtarif') ||
          msgLower.includes('epex')
        ) {
          if (
            msgLower.includes('risiko') ||
            msgLower.includes('preisschwankung') ||
            msgLower.includes('schwankung') ||
            msgLower.includes('gefahr')
          ) {
          ...
          msgLower.includes('14a') ||
          msgLower.includes('dimmung') ||
          msgLower.includes('steuerbare verbrauchseinrichtung')
        ) {
          detectedIntent = 'section14a_consumer';
        } else if (
          msgLower.includes('marktstammdatenregister') ||
          msgLower.includes('mastr') ||
          msgLower.includes('registrierung') ||
          msgLower.includes('anmeldung')
        ) {
          detectedIntent = 'mastr_registration_qa';
        } else if (
          msgLower.includes('einspeisung') ||
          msgLower.includes('einspeisevergütung') ||
          msgLower.includes('einspeiseverguetung')
        ) {
          if (
            msgLower.includes('wirtschaftlichkeit') ||
            msgLower.includes('ökonomie') ||
            msgLower.includes('rendite') ||
            msgLower.includes('lohnt')
          ) {
          ...
          msgLower.includes('sharing') ||
          msgLower.includes('teilen') ||
          msgLower.includes('gemeinschaft')
        ) {
          detectedIntent = 'community_energy_sharing_explain';
        } else if (
          msgLower.includes('smart meter') ||
          msgLower.includes('imsys') ||
          msgLower.includes('messstellenbetrieb') ||
          msgLower.includes('gateway')
        ) {
          detectedIntent = 'smart_meter_basics';
        } else if (
          msgLower.includes('rechnung') ||
          msgLower.includes('abrechnung') ||
          msgLower.includes('stromrechnung')
        ) {
          detectedIntent = 'bill_explainer';
        } else if (
          msgLower.includes('wechsel') ||
          msgLower.includes('kostenvergleich') ||
          msgLower.includes('anbieterwechsel')
        ) {
          detectedIntent = 'supplier_cost_check';
        } else if (
          msgLower.includes('grünstrom') ||
          msgLower.includes('gruenstrom') ||
          msgLower.includes('ökostrom') ||
          msgLower.includes('gsi') ||
          msgLower.includes('grünstrom-index')
        ) {
          detectedIntent = 'green_power_literacy';
        } else if (
          msgLower.includes('datenschutz') ||
          msgLower.includes('dsgvo') ||
          msgLower.includes('datenleiter') ||
          msgLower.includes('privatsphäre')
        ) {
          detectedIntent = 'privacy_data_ladder';
        } else if (
          msgLower.includes('corrently-tarif') ||
          msgLower.includes('corrently tarif') ||
          msgLower.includes('passform')
        ) {
        ...
        if (extractedLocation) {
          ...
          if (
            msgLower.includes('netzbetreiber') ||
            msgLower.includes('vnb') ||
            msgLower.includes('zuständig') ||
            msgLower.includes('wer ist') ||
            msgLower.includes('welcher')
          ) {
            try {
              ...
              if (vnbResult && vnbResult.success !== false) {
                const vnbName =
                  vnbResult.companyName ||
                  vnbResult.data?.companyName ||
                ...
                openQuestions.unshift(
                  `Für genauere VNB-Informationen zu ${extractedLocation} fehlen uns zusätzliche Detaildaten.`
                );
              }
            } catch (err) {
              // Gracefully handle error without leaking details
              this.logger.warn(
                `VNB lookup failed during community.consult delegation: ${err.message}`
              );
            }
          }
          ...
          if (
            msgLower.includes('co2') ||
            msgLower.includes('gsi') ||
            msgLower.includes('grünstrom') ||
            msgLower.includes('gruenstrom') ||
            msgLower.includes('prognose') ||
            msgLower.includes('last')
          ) {
            try {
              ...
              if (co2Result && co2Result.success !== false) {
                const co2Val =
                  co2Result.co2_intensity_gco2eq_kwh ||
                  co2Result.co2Intensity ||
                  co2Result.data?.co2Intensity;
                if (co2Val) {
              ...
              this.logger.warn(
                `CO2 Intensity call failed during community.consult delegation: ${err.message}`
              );
            }
          }
        } else {
          ...
          if (
            ...
            openQuestions.unshift(
              'Bitte geben Sie Ihre 5-stellige Postleitzahl oder Ihren Wohnort an, um eine genaue Auskunft zu erhalten.'
            );
          }
        }
