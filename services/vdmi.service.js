        ...
        return {
          ...
          dossier: {
            ...
            task: {
              ...
              processId: matrix.processId || null,
              matrixId: matrix.id,
              assetClass: task?.assetClass || null,
              assetId: task?.assetId || null,
              verantwortlich: toArray(task?.verantwortlich),
              durchfuehrend: toArray(task?.durchfuehrend),
              mitwirkend: toArray(task?.mitwirkend),
              information: toArray(task?.information),
